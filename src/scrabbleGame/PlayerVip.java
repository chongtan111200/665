...
/**
 * This is the class for VIP players
 * @author chong tian
 *
 */
public class PlayerVip implements PlayerInterface {
	...
	/**
	 * 
	 * @return score of VIP player, gets 2 times the regular score as bonus
	 * @override
	 */
	public int getScore() {
		return 2 * score;
